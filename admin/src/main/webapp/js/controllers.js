...
angular.module('admin.controllers', [] )
	.controller('ModalWindowCtrl', [ '$scope', '$modal',  function ($scope, $modal ) {
  	    ...
  	    $scope.modalInstance = $modal.open({
  	      ...
  	      templateUrl: (params.isDeploymentTemplate)?'templateContentDeployment':'templateContentRegistration',
	...
	.controller('AdminCtrl', ['$scope', '$http', function($scope, $http){
	       ...
	       $scope.deployerStatuses[$scope.statuses.length] = {name:"UNDEPLOYED", deployerValue:"Undeployed", registrationValue: "ACTIVE"};
