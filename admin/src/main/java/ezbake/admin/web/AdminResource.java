...
public class AdminResource extends AdminResourceBase {
	...
	public Response registerApp(@PathParam("appSecId") String appSecId,
		...
		try {
			...
			if(isApproved) {
                addUsersAndGroups(appReg, serviceClient);
    ...
    private void addUsersAndGroups(ApplicationRegistration appReg, ServiceClient serviceClient) throws TException{
        ...
        try {
            ...
            groupsClient = serviceClient.getClientPool().getClient(EzGroupsConstants.SERVICE_NAME,
