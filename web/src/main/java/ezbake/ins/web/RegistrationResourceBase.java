...
import ezbake.services.classification.thrift.ClassificationServiceConstants;
...
public class RegistrationResourceBase {
    ...
    protected ClassificationService.Client getClassificationServiceClient(ServiceClient resource) throws TException {
    	return resource.getClientPool().getClient(ClassificationServiceConstants.SERVICE_NAME,
                ClassificationService.Client.class);
    }
